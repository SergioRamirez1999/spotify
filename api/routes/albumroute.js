...
api.put('/managed-albums/image/:id', [md_auth.ensureAuth, md_upload], albumController.uploadImage);
...
api.get('/managed-albums/image/:imageFile', albumController.getImageFile);
